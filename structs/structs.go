...
type ServerConfig struct {
	...
	// Tickets is the directory in which all tickets are stored.
	Tickets string

	// User is the path to the users.json file.
	Users string

	// Mails is the directory in which all mails are stored.
	Mails string
	...
	// Web is the root directory of the server where web resources are located.
	Web string
}
